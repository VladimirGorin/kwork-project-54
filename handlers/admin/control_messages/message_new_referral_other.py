...
router = Router()
param_code = 'message_new_referral_other'
button_caption = 'Новый реферал, остальные случаи'
...
async def handler(message: Message, state: FSMContext):
    ...
    await state.set_state(AdminState.WaitingNewReferalOtherMessage)


@router.message(StateFilter(AdminState.WaitingNewReferalOtherMessage))
