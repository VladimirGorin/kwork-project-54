...
router = Router()
param_code_message = 'message_get_gift_success'
button_caption = 'Получить подарок - успех'
...
async def handler(message: Message, state: FSMContext):
    ...
    await state.set_state(AdminState.WaitingGetGiftSuccessMessage)


@router.message(StateFilter(AdminState.WaitingGetGiftSuccessMessage))
